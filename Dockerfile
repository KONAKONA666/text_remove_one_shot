...
RUN cd /home/konakona/src \
    ...
    && python3.9 -m pip install torch torchvision torchaudio --extra-index-url https://download.pytorch.org/whl/cu116 scipy numpy kornia scikit-image matplotlib torchsummary tensorboard opencv-python-headless pyyaml
